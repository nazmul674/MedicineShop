  ...
  <!DOCTYPE HTML>
   <html>
    ...
    <body bgcolor="lightblue" > 
      ...
      <tr align="center">
          <td colspan="2"> <h2>Update existing product</h2></td>
      </tr>
      <tr >
    ...
    <tr>
      ...
      <td><input type= "text" name="product_id" /></td>
         ...
         <tr align="center">
          <td colspan="2"><input type ="submit" name="insert_product" value="Update"></td>
          </tr>
...
SET 
drug_title='$product_title',
cat_id='$product_cat',
brand_id='$product_brand',
drug_image1='$product_image1',
drug_image2='$product_image2',
price='$product_price',
drug_des='$product_des',
status='status' 
WHERE
drug_id='$product_id'";
...
if($run_product)
{
echo "<script>alert ('updated_successfully')</script>";
}
else{
